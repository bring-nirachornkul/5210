...
def find_weight(warehouse: WareHouse, start: str, end: str) -> int:
    '''
        This returns how many steps it takes to move from a point to a point in a matrix
        :param warehouse: Map of the warehouse
        :param start: The starting point
        :param end: The end point
    '''
    h_move = abs(warehouse.location[start][0] - warehouse.location[end][0])
    v_move = abs(warehouse.location[start][1] - warehouse.location[end][1])
